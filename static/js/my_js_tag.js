...
function showByColorBar(num){
    for (i=0;i<100;i++){
        try{
            if (parseInt(document.getElementById("connection-"+i.toString()).childNodes[0].childNodes[3].style.right) < num+11 && parseInt(document.getElementById("connection-"+i.toString()).childNodes[0].childNodes[3].style.right) > num-11){
